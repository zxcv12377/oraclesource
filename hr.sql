...
FROM EMPLOYEES E
WHERE E.LAST_NAME LIKE ('%u%')  AND E.SALARY > (SELECT ROUND(AVG(E.SALARY))
FROM EMPLOYEES e));
...
GROUP BY
	E.DEPARTMENT_ID) p
WHERE
	E.DEPARTMENT_ID = P.DEPARTMENT_ID AND P.DEPT_SAL_AVG < E.SALARY ORDER BY E.DEPARTMENT_ID  ;
...
WHERE
	(E.SALARY,
	NVL(E.COMMISSION_PCT,0)) IN (SELECT DISTINCT E.SALARY, NVL(E.COMMISSION_PCT,0)
